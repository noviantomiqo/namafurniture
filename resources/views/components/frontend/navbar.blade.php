          ...
          <div class="w-56 items-center flex">
            <a href="{{ route('index') }}">
              <img
                ...
                alt="NAMA | Fulfill your house with beautiful furniture"/>
            </a>
          </div>
          ...
          <div class="w-auto">
            <ul
              ...
              <li class="mx-3 py-6 md:py-0">
                <a href="#recommendation" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline"
                  >Recommendation</a>
              </li>
              <li class="mx-3 py-6 md:py-0">
                <a href="#catalog" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline"
                  >Products</a>
              </li>
              @auth
                  <li class="mx-3 py-6 md:py-0">
