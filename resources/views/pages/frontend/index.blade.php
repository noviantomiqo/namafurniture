...
@section('content')
    ...
    <section id="recommendation" class="bg-gray-100 mb-8">
      ...
      <div class="container mx-auto px-6 flex flex-wrap justify-center">
              @foreach ($recommendations as $recommendation)
                  <div class="px-3 flex-none" style="width: 320px">
                    <div class="rounded-xl p-4 pb-8 relative bg-white mb-6">
                      ...
                      <h5 class="text-lg font-semibold mt-3">{{ $recommendation->name }}</h5>
    ...
    <section id="catalog">
      ...
      <div class="container mx-auto px-6 flex flex-wrap justify-center">
          ...
          @foreach($products as $product)
            <div class="px-4 mx-auto mb-8 relative card group">
              <div
