...
class ProductGalleryController extends Controller
{
    ...
    public function index(Product $product)
    {
        ...
        return view('pages.dashboard.gallery.index', compact('product')); //dasboard gallery index  
    }
    ...
    {
        return view('pages.dashboard.gallery.create', compact('product')); //dasboard gallery create 
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(ProductGalleryRequest $request, ProductGallery $gallery) //produk gallery update 
    {
        //
    }
